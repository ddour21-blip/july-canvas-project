      ...
      <div class="pframe">
        ...
        <div class="pf-body">
          ...
          <div class="pf-main">
            ...
            <div class="pf-cards">
              <div class="pf-card">
                <div class="pf-r1"><span class="pf-nm">AI 영화제</span><span class="pf-st"><span class="d" style="background:#cbd5e1"></span>초안</span></div>
              ...
              <div class="pf-card">
                <div class="pf-r1"><span class="pf-nm">엑스루 빌더</span><span class="pf-st"><span class="d" style="background:var(--primary)"></span>진행 중</span></div>
...
<section class="section flow" id="flow">
  <div class="wrap flow-grid">
    <div class="jcl-ring-wrap"><div class="jcl-ring">
